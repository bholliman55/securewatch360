...
**Control:** `APO05`  
**Summary:** COBIT 2019 — APO05 Managed portfolio

## Purpose

Organization-level policy/procedure template aligned to control `APO05`. Replace bracketed fields; not legal advice.
