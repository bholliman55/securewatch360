...
**Control:** `BAI10`  
**Summary:** COBIT 2019 — BAI10 Managed configuration

## Purpose

Organization-level policy/procedure template aligned to control `BAI10`. Replace bracketed fields; not legal advice.
