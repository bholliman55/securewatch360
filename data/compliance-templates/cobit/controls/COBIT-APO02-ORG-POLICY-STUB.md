...
**Control:** `APO02`  
**Summary:** COBIT 2019 — APO02 Managed strategy

## Purpose

Organization-level policy/procedure template aligned to control `APO02`. Replace bracketed fields; not legal advice.
