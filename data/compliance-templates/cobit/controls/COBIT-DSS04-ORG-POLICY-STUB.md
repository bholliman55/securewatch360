...
**Control:** `DSS04`  
**Summary:** COBIT 2019 — DSS04 Managed continuity

## Purpose

Organization-level policy/procedure template aligned to control `DSS04`. Replace bracketed fields; not legal advice.
