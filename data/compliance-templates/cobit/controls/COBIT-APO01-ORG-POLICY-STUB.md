...
**Control:** `APO01`  
**Summary:** COBIT 2019 — APO01 Managed I&T management framework

## Purpose

Organization-level policy/procedure template aligned to control `APO01`. Replace bracketed fields; not legal advice.
