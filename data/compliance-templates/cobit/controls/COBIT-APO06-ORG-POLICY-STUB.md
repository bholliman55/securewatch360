...
**Control:** `APO06`  
**Summary:** COBIT 2019 — APO06 Managed budget and costs

## Purpose

Organization-level policy/procedure template aligned to control `APO06`. Replace bracketed fields; not legal advice.
