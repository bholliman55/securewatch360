...
**Framework:** COBIT (SecureWatch360 policy pack catalog)  
**Control:** `MEA01`  
**Summary:** COBIT 2019 — MEA01 Managed performance and conformance monitoring

## Purpose

Organization-level policy/procedure template aligned to control `MEA01`. Replace bracketed fields; not legal advice.
