...
**Control:** `EDM04`  
**Summary:** COBIT 2019 — EDM04 Resource optimization

## Purpose

Organization-level policy/procedure template aligned to control `EDM04`. Replace bracketed fields; not legal advice.
