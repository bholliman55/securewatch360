...
**Control:** `APO03`  
**Summary:** COBIT 2019 — APO03 Managed enterprise architecture

## Purpose

Organization-level policy/procedure template aligned to control `APO03`. Replace bracketed fields; not legal advice.
