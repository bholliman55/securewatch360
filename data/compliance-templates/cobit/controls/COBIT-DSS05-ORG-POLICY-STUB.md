...
**Control:** `DSS05`  
**Summary:** COBIT 2019 — DSS05 Managed security services

## Purpose

Organization-level policy/procedure template aligned to control `DSS05`. Replace bracketed fields; not legal advice.
