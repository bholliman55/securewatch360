...
**Control:** `APO11`  
**Summary:** COBIT 2019 — APO11 Managed quality

## Purpose

Organization-level policy/procedure template aligned to control `APO11`. Replace bracketed fields; not legal advice.
