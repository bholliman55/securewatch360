...
**Control:** `BAI09`  
**Summary:** COBIT 2019 — BAI09 Managed assets

## Purpose

Organization-level policy/procedure template aligned to control `BAI09`. Replace bracketed fields; not legal advice.
