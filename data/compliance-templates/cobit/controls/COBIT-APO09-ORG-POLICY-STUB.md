...
**Control:** `APO09`  
**Summary:** COBIT 2019 — APO09 Managed service agreements

## Purpose

Organization-level policy/procedure template aligned to control `APO09`. Replace bracketed fields; not legal advice.
