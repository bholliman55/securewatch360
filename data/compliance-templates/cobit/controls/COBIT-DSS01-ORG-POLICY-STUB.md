...
**Control:** `DSS01`  
**Summary:** COBIT 2019 — DSS01 Managed operations

## Purpose

Organization-level policy/procedure template aligned to control `DSS01`. Replace bracketed fields; not legal advice.
