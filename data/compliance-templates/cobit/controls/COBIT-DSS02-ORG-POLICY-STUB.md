...
**Control:** `DSS02`  
**Summary:** COBIT 2019 — DSS02 Managed service requests and incidents

## Purpose

Organization-level policy/procedure template aligned to control `DSS02`. Replace bracketed fields; not legal advice.
