...
**Control:** `EDM01`  
**Summary:** COBIT 2019 — EDM01 Governance framework setting and maintenance

## Purpose

Organization-level policy/procedure template aligned to control `EDM01`. Replace bracketed fields; not legal advice.
