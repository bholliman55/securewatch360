...
**Control:** `BAI11`  
**Summary:** COBIT 2019 — BAI11 Managed projects

## Purpose

Organization-level policy/procedure template aligned to control `BAI11`. Replace bracketed fields; not legal advice.
