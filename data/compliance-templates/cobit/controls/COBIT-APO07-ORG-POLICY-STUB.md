...
**Control:** `APO07`  
**Summary:** COBIT 2019 — APO07 Managed people

## Purpose

Organization-level policy/procedure template aligned to control `APO07`. Replace bracketed fields; not legal advice.
