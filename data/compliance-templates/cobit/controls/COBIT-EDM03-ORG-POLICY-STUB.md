...
**Control:** `EDM03`  
**Summary:** COBIT 2019 — EDM03 Risk optimization

## Purpose

Organization-level policy/procedure template aligned to control `EDM03`. Replace bracketed fields; not legal advice.
