...
**Control:** `BAI01`  
**Summary:** COBIT 2019 — BAI01 Managed programs

## Purpose

Organization-level policy/procedure template aligned to control `BAI01`. Replace bracketed fields; not legal advice.
