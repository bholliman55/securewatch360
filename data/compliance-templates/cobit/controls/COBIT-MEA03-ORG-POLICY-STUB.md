...
**Control:** `MEA03`  
**Summary:** COBIT 2019 — MEA03 Managed compliance with external requirements

## Purpose

Organization-level policy/procedure template aligned to control `MEA03`. Replace bracketed fields; not legal advice.
