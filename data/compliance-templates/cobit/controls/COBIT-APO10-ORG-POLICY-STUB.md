...
**Control:** `APO10`  
**Summary:** COBIT 2019 — APO10 Managed vendors

## Purpose

Organization-level policy/procedure template aligned to control `APO10`. Replace bracketed fields; not legal advice.
