...
**Control:** `DSS03`  
**Summary:** COBIT 2019 — DSS03 Managed problems

## Purpose

Organization-level policy/procedure template aligned to control `DSS03`. Replace bracketed fields; not legal advice.
