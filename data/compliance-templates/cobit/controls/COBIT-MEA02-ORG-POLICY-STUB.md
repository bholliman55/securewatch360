...
**Control:** `MEA02`  
**Summary:** COBIT 2019 — MEA02 Managed system of internal control

## Purpose

Organization-level policy/procedure template aligned to control `MEA02`. Replace bracketed fields; not legal advice.
