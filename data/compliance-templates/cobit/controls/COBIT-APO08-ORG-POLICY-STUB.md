...
**Control:** `APO08`  
**Summary:** COBIT 2019 — APO08 Managed relationships

## Purpose

Organization-level policy/procedure template aligned to control `APO08`. Replace bracketed fields; not legal advice.
