...
**Control:** `BAI03`  
**Summary:** COBIT 2019 — BAI03 Managed solutions identification and build

## Purpose

Organization-level policy/procedure template aligned to control `BAI03`. Replace bracketed fields; not legal advice.
