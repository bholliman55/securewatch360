...
**Control:** `APO13`  
**Summary:** COBIT 2019 — APO13 Managed security

## Purpose

Organization-level policy/procedure template aligned to control `APO13`. Replace bracketed fields; not legal advice.
