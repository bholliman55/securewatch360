...
**Control:** `DSS06`  
**Summary:** COBIT 2019 — DSS06 Managed business process controls

## Purpose

Organization-level policy/procedure template aligned to control `DSS06`. Replace bracketed fields; not legal advice.
