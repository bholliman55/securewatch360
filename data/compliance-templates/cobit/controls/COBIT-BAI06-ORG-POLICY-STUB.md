...
**Control:** `BAI06`  
**Summary:** COBIT 2019 — BAI06 Managed IT changes

## Purpose

Organization-level policy/procedure template aligned to control `BAI06`. Replace bracketed fields; not legal advice.
