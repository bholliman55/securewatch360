...
**Control:** `BAI02`  
**Summary:** COBIT 2019 — BAI02 Managed requirements definition

## Purpose

Organization-level policy/procedure template aligned to control `BAI02`. Replace bracketed fields; not legal advice.
