...
**Control:** `IA-8`  
**Summary:** Identification and Authentication (Non-organizational Users)

## Purpose

Organization-level policy/procedure template aligned to control `IA-8`. Replace bracketed fields; not legal advice.
