...
**Control:** `CM-7.5`  
**Summary:** Authorized Software — Allow-by-exception

## Purpose

Organization-level policy/procedure template aligned to control `CM-7.5`. Replace bracketed fields; not legal advice.
