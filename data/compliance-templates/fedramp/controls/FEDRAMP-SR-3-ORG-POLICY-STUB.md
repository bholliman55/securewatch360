...
**Control:** `SR-3`  
**Summary:** Supply Chain Controls and Processes

## Purpose

Organization-level policy/procedure template aligned to control `SR-3`. Replace bracketed fields; not legal advice.
