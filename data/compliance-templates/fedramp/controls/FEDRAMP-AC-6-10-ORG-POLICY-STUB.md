...
**Control:** `AC-6.10`  
**Summary:** Prohibit Non-privileged Users from Executing Privileged Functions

## Purpose

Organization-level policy/procedure template aligned to control `AC-6.10`. Replace bracketed fields; not legal advice.
