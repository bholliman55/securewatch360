...
**Control:** `AC-17.3`  
**Summary:** Managed Access Control Points

## Purpose

Organization-level policy/procedure template aligned to control `AC-17.3`. Replace bracketed fields; not legal advice.
