...
**Control:** `SC-20`  
**Summary:** Secure Name/Address Resolution Service (Authoritative Source)

## Purpose

Organization-level policy/procedure template aligned to control `SC-20`. Replace bracketed fields; not legal advice.
