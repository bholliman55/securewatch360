...
**Control:** `IA-5.2`  
**Summary:** Public Key-based Authentication

## Purpose

Organization-level policy/procedure template aligned to control `IA-5.2`. Replace bracketed fields; not legal advice.
