...
**Control:** `IA-2.1`  
**Summary:** Multi-factor Authentication to Privileged Accounts

## Purpose

Organization-level policy/procedure template aligned to control `IA-2.1`. Replace bracketed fields; not legal advice.
