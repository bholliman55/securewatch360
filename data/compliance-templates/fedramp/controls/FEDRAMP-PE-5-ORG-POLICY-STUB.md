...
**Control:** `PE-5`  
**Summary:** Access Control for Output Devices

## Purpose

Organization-level policy/procedure template aligned to control `PE-5`. Replace bracketed fields; not legal advice.
