...
**Control:** `IA-2`  
**Summary:** Identification and Authentication (Organizational Users)

## Purpose

Organization-level policy/procedure template aligned to control `IA-2`. Replace bracketed fields; not legal advice.
