...
**Control:** `SC-22`  
**Summary:** Architecture and Provisioning for Name/Address Resolution Service

## Purpose

Organization-level policy/procedure template aligned to control `SC-22`. Replace bracketed fields; not legal advice.
