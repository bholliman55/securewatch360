...
**Control:** `CM-12.1`  
**Summary:** Automated Tools to Support Information Location

## Purpose

Organization-level policy/procedure template aligned to control `CM-12.1`. Replace bracketed fields; not legal advice.
