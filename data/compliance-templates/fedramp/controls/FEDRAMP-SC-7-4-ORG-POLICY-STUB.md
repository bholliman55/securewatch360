...
**Control:** `SC-7.4`  
**Summary:** External Telecommunications Services

## Purpose

Organization-level policy/procedure template aligned to control `SC-7.4`. Replace bracketed fields; not legal advice.
