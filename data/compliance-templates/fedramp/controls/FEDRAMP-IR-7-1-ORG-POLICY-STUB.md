...
**Control:** `IR-7.1`  
**Summary:** Automation Support for Availability of Information and Support

## Purpose

Organization-level policy/procedure template aligned to control `IR-7.1`. Replace bracketed fields; not legal advice.
