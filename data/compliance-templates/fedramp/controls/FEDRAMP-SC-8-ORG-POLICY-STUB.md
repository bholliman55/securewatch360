...
**Control:** `SC-8`  
**Summary:** Transmission Confidentiality and Integrity

## Purpose

Organization-level policy/procedure template aligned to control `SC-8`. Replace bracketed fields; not legal advice.
