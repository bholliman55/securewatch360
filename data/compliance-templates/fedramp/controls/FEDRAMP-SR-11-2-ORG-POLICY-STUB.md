...
**Control:** `SR-11.2`  
**Summary:** Configuration Control for Component Service and Repair

## Purpose

Organization-level policy/procedure template aligned to control `SR-11.2`. Replace bracketed fields; not legal advice.
