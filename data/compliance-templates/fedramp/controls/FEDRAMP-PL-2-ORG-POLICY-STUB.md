...
**Control:** `PL-2`  
**Summary:** System Security and Privacy Plans

## Purpose

Organization-level policy/procedure template aligned to control `PL-2`. Replace bracketed fields; not legal advice.
