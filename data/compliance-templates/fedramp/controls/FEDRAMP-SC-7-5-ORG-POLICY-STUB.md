...
**Control:** `SC-7.5`  
**Summary:** Deny by Default — Allow by Exception

## Purpose

Organization-level policy/procedure template aligned to control `SC-7.5`. Replace bracketed fields; not legal advice.
