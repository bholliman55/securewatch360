...
**Control:** `AU-9.4`  
**Summary:** Access by Subset of Privileged Users

## Purpose

Organization-level policy/procedure template aligned to control `AU-9.4`. Replace bracketed fields; not legal advice.
