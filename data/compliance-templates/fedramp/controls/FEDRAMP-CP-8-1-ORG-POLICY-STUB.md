...
**Control:** `CP-8.1`  
**Summary:** Priority of Service Provisions

## Purpose

Organization-level policy/procedure template aligned to control `CP-8.1`. Replace bracketed fields; not legal advice.
