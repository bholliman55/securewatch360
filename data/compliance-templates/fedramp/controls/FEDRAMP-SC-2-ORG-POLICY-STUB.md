...
**Control:** `SC-2`  
**Summary:** Separation of System and User Functionality

## Purpose

Organization-level policy/procedure template aligned to control `SC-2`. Replace bracketed fields; not legal advice.
