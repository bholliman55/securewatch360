...
**Control:** `PE-6.1`  
**Summary:** Intrusion Alarms and Surveillance Equipment

## Purpose

Organization-level policy/procedure template aligned to control `PE-6.1`. Replace bracketed fields; not legal advice.
