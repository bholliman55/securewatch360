...
**Control:** `IA-2.2`  
**Summary:** Multi-factor Authentication to Non-privileged Accounts

## Purpose

Organization-level policy/procedure template aligned to control `IA-2.2`. Replace bracketed fields; not legal advice.
