...
**Control:** `IA-2.12`  
**Summary:** Acceptance of PIV Credentials

## Purpose

Organization-level policy/procedure template aligned to control `IA-2.12`. Replace bracketed fields; not legal advice.
