...
**Control:** `SI-7`  
**Summary:** Software, Firmware, and Information Integrity

## Purpose

Organization-level policy/procedure template aligned to control `SI-7`. Replace bracketed fields; not legal advice.
