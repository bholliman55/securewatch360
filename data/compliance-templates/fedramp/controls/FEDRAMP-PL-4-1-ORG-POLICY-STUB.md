...
**Control:** `PL-4.1`  
**Summary:** Social Media and External Site/Application Usage Restrictions

## Purpose

Organization-level policy/procedure template aligned to control `PL-4.1`. Replace bracketed fields; not legal advice.
