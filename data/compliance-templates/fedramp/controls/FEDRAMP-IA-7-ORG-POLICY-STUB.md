...
**Control:** `IA-7`  
**Summary:** Cryptographic Module Authentication

## Purpose

Organization-level policy/procedure template aligned to control `IA-7`. Replace bracketed fields; not legal advice.
