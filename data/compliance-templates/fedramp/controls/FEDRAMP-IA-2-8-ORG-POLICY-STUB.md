...
**Control:** `IA-2.8`  
**Summary:** Access to Accounts — Replay Resistant

## Purpose

Organization-level policy/procedure template aligned to control `IA-2.8`. Replace bracketed fields; not legal advice.
