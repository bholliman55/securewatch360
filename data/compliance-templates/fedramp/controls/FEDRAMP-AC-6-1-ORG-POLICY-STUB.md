...
**Control:** `AC-6.1`  
**Summary:** Authorize Access to Security Functions

## Purpose

Organization-level policy/procedure template aligned to control `AC-6.1`. Replace bracketed fields; not legal advice.
