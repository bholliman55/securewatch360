...
**Control:** `AC-6.2`  
**Summary:** Non-privileged Access for Nonsecurity Functions

## Purpose

Organization-level policy/procedure template aligned to control `AC-6.2`. Replace bracketed fields; not legal advice.
