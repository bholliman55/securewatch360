...
**Control:** `CM-2.3`  
**Summary:** Retention of Previous Configurations

## Purpose

Organization-level policy/procedure template aligned to control `CM-2.3`. Replace bracketed fields; not legal advice.
