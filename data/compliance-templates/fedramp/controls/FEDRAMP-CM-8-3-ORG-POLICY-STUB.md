...
**Control:** `CM-8.3`  
**Summary:** Automated Unauthorized Component Detection

## Purpose

Organization-level policy/procedure template aligned to control `CM-8.3`. Replace bracketed fields; not legal advice.
