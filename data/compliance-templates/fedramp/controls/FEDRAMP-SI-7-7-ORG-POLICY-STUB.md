...
**Control:** `SI-7.7`  
**Summary:** Integration of Detection and Response

## Purpose

Organization-level policy/procedure template aligned to control `SI-7.7`. Replace bracketed fields; not legal advice.
