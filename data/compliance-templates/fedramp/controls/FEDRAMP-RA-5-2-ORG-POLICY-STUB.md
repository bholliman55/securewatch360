...
**Control:** `RA-5.2`  
**Summary:** Update Vulnerabilities to Be Scanned

## Purpose

Organization-level policy/procedure template aligned to control `RA-5.2`. Replace bracketed fields; not legal advice.
