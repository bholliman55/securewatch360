...
**Control:** `SI-2.2`  
**Summary:** Automated Flaw Remediation Status

## Purpose

Organization-level policy/procedure template aligned to control `SI-2.2`. Replace bracketed fields; not legal advice.
