...
**Control:** `SC-17`  
**Summary:** Public Key Infrastructure Certificates

## Purpose

Organization-level policy/procedure template aligned to control `SC-17`. Replace bracketed fields; not legal advice.
