...
**Control:** `SA-4.1`  
**Summary:** Functional Properties of Controls

## Purpose

Organization-level policy/procedure template aligned to control `SA-4.1`. Replace bracketed fields; not legal advice.
