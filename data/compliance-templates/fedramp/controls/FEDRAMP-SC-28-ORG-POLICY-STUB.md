...
**Control:** `SC-28`  
**Summary:** Protection of Information at Rest

## Purpose

Organization-level policy/procedure template aligned to control `SC-28`. Replace bracketed fields; not legal advice.
