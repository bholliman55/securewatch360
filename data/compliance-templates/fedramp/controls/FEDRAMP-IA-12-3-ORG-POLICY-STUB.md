...
**Control:** `IA-12.3`  
**Summary:** Identity Evidence Validation and Verification

## Purpose

Organization-level policy/procedure template aligned to control `IA-12.3`. Replace bracketed fields; not legal advice.
