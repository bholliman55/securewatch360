...
**Control:** `SI-12`  
**Summary:** Information Management and Retention

## Purpose

Organization-level policy/procedure template aligned to control `SI-12`. Replace bracketed fields; not legal advice.
