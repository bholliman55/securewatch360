...
**Control:** `PE-13.1`  
**Summary:** Detection Systems — Automatic Activation and Notification

## Purpose

Organization-level policy/procedure template aligned to control `PE-13.1`. Replace bracketed fields; not legal advice.
