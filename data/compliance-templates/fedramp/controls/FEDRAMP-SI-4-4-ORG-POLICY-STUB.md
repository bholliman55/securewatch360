...
**Control:** `SI-4.4`  
**Summary:** Inbound and Outbound Communications Traffic

## Purpose

Organization-level policy/procedure template aligned to control `SI-4.4`. Replace bracketed fields; not legal advice.
