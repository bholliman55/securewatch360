...
**Control:** `SC-7.7`  
**Summary:** Split Tunneling for Remote Devices

## Purpose

Organization-level policy/procedure template aligned to control `SC-7.7`. Replace bracketed fields; not legal advice.
