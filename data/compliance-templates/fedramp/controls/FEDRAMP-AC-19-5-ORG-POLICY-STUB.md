...
**Control:** `AC-19.5`  
**Summary:** Full Device or Container-based Encryption

## Purpose

Organization-level policy/procedure template aligned to control `AC-19.5`. Replace bracketed fields; not legal advice.
