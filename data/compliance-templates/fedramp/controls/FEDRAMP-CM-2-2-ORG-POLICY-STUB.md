...
**Control:** `CM-2.2`  
**Summary:** Automation Support for Accuracy and Currency

## Purpose

Organization-level policy/procedure template aligned to control `CM-2.2`. Replace bracketed fields; not legal advice.
