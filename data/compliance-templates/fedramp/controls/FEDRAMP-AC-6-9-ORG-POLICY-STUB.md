...
**Control:** `AC-6.9`  
**Summary:** Log Use of Privileged Functions

## Purpose

Organization-level policy/procedure template aligned to control `AC-6.9`. Replace bracketed fields; not legal advice.
