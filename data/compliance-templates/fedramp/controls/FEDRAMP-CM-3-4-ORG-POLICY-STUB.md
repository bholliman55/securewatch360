...
**Control:** `CM-3.4`  
**Summary:** Security and Privacy Representatives

## Purpose

Organization-level policy/procedure template aligned to control `CM-3.4`. Replace bracketed fields; not legal advice.
