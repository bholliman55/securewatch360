...
**Control:** `SC-7.8`  
**Summary:** Route Traffic to Authenticated Proxy Servers

## Purpose

Organization-level policy/procedure template aligned to control `SC-7.8`. Replace bracketed fields; not legal advice.
