...
**Framework:** FEDRAMP (SecureWatch360 policy pack catalog)  
**Control:** `SC-21`  
**Summary:** Secure Name/Address Resolution Service (Recursive or Caching Resolver)

## Purpose

Organization-level policy/procedure template aligned to control `SC-21`. Replace bracketed fields; not legal advice.
