...
**Control:** `CM-2.7`  
**Summary:** Configure Systems and Components for High-risk Areas

## Purpose

Organization-level policy/procedure template aligned to control `CM-2.7`. Replace bracketed fields; not legal advice.
