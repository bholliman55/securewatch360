...
**Control:** `PL-8`  
**Summary:** Security and Privacy Architectures

## Purpose

Organization-level policy/procedure template aligned to control `PL-8`. Replace bracketed fields; not legal advice.
