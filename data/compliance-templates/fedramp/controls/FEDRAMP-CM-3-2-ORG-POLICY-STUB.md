...
**Control:** `CM-3.2`  
**Summary:** Testing, Validation, and Documentation of Changes

## Purpose

Organization-level policy/procedure template aligned to control `CM-3.2`. Replace bracketed fields; not legal advice.
