...
**Control:** `IA-8.2`  
**Summary:** Acceptance of External Authenticators

## Purpose

Organization-level policy/procedure template aligned to control `IA-8.2`. Replace bracketed fields; not legal advice.
