...
**Control:** `CM-8.1`  
**Summary:** Updates During Installation and Removal

## Purpose

Organization-level policy/procedure template aligned to control `CM-8.1`. Replace bracketed fields; not legal advice.
