...
**Control:** `AU-6.3`  
**Summary:** Correlate Audit Record Repositories

## Purpose

Organization-level policy/procedure template aligned to control `AU-6.3`. Replace bracketed fields; not legal advice.
