...
**Control:** `AC-20.2`  
**Summary:** Portable Storage Devices — Restricted Use

## Purpose

Organization-level policy/procedure template aligned to control `AC-20.2`. Replace bracketed fields; not legal advice.
