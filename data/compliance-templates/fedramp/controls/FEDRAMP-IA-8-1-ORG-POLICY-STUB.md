...
**Control:** `IA-8.1`  
**Summary:** Acceptance of PIV Credentials from Other Agencies

## Purpose

Organization-level policy/procedure template aligned to control `IA-8.1`. Replace bracketed fields; not legal advice.
