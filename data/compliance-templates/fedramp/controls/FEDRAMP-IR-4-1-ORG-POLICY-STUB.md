...
**Control:** `IR-4.1`  
**Summary:** Automated Incident Handling Processes

## Purpose

Organization-level policy/procedure template aligned to control `IR-4.1`. Replace bracketed fields; not legal advice.
