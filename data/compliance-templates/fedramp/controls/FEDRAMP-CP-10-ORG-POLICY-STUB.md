...
**Control:** `CP-10`  
**Summary:** System Recovery and Reconstitution

## Purpose

Organization-level policy/procedure template aligned to control `CP-10`. Replace bracketed fields; not legal advice.
