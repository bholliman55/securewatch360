...
**Control:** `SA-9.2`  
**Summary:** Identification of Functions, Ports, Protocols, and Services

## Purpose

Organization-level policy/procedure template aligned to control `SA-9.2`. Replace bracketed fields; not legal advice.
