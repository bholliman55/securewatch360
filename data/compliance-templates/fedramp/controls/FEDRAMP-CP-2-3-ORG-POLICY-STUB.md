...
**Control:** `CP-2.3`  
**Summary:** Resume Mission and Business Functions

## Purpose

Organization-level policy/procedure template aligned to control `CP-2.3`. Replace bracketed fields; not legal advice.
