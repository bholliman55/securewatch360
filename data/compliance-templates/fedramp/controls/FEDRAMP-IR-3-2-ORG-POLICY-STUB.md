...
**Control:** `IR-3.2`  
**Summary:** Coordination with Related Plans

## Purpose

Organization-level policy/procedure template aligned to control `IR-3.2`. Replace bracketed fields; not legal advice.
