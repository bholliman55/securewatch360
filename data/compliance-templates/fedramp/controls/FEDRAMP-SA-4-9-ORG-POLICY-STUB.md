...
**Control:** `SA-4.9`  
**Summary:** Functions, Ports, Protocols, and Services in Use

## Purpose

Organization-level policy/procedure template aligned to control `SA-4.9`. Replace bracketed fields; not legal advice.
