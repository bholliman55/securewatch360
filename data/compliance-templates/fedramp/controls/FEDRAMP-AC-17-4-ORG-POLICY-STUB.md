...
**Control:** `AC-17.4`  
**Summary:** Privileged Commands and Access

## Purpose

Organization-level policy/procedure template aligned to control `AC-17.4`. Replace bracketed fields; not legal advice.
