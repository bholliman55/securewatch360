...
**Control:** `AC-17.2`  
**Summary:** Protection of Confidentiality and Integrity Using Encryption

## Purpose

Organization-level policy/procedure template aligned to control `AC-17.2`. Replace bracketed fields; not legal advice.
