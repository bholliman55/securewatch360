...
**Control:** `SR-10`  
**Summary:** Inspection of Systems or Components

## Purpose

Organization-level policy/procedure template aligned to control `SR-10`. Replace bracketed fields; not legal advice.
