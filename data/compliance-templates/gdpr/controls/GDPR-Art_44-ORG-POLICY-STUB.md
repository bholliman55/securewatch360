...
**Control:** `Art_44`  
**Summary:** GDPR Article 44 — General principle for transfers

## Purpose

Organization-level policy/procedure template aligned to control `Art_44`. Replace bracketed fields; not legal advice.
