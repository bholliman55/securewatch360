...
**Control:** `Art_37`  
**Summary:** GDPR Article 37 — Designation of the data protection officer

## Purpose

Organization-level policy/procedure template aligned to control `Art_37`. Replace bracketed fields; not legal advice.
