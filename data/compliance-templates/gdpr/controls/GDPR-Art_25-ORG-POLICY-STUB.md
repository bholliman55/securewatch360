...
**Control:** `Art_25`  
**Summary:** GDPR Article 25 — Data protection by design and by default

## Purpose

Organization-level policy/procedure template aligned to control `Art_25`. Replace bracketed fields; not legal advice.
