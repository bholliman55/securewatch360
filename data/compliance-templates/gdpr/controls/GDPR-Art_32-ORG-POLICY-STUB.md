...
**Control:** `Art_32`  
**Summary:** GDPR Article 32 — Security of processing

## Purpose

Organization-level policy/procedure template aligned to control `Art_32`. Replace bracketed fields; not legal advice.
