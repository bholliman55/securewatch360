...
**Control:** `Art_49`  
**Summary:** GDPR Article 49 — Derogations for specific situations

## Purpose

Organization-level policy/procedure template aligned to control `Art_49`. Replace bracketed fields; not legal advice.
