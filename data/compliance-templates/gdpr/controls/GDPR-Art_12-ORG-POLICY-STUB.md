...
**Control:** `Art_12`  
**Summary:** GDPR Article 12 — Transparent information and communication

## Purpose

Organization-level policy/procedure template aligned to control `Art_12`. Replace bracketed fields; not legal advice.
