...
**Control:** `Art_18`  
**Summary:** GDPR Article 18 — Right to restriction of processing

## Purpose

Organization-level policy/procedure template aligned to control `Art_18`. Replace bracketed fields; not legal advice.
