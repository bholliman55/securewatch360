...
**Control:** `Art_46`  
**Summary:** GDPR Article 46 — Transfers subject to appropriate safeguards

## Purpose

Organization-level policy/procedure template aligned to control `Art_46`. Replace bracketed fields; not legal advice.
