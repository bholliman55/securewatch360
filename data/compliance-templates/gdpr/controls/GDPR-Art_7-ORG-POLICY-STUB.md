...
**Control:** `Art_7`  
**Summary:** GDPR Article 7 — Conditions for consent

## Purpose

Organization-level policy/procedure template aligned to control `Art_7`. Replace bracketed fields; not legal advice.
