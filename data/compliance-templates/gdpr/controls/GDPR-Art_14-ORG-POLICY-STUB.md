...
**Control:** `Art_14`  
**Summary:** GDPR Article 14 — Information to be provided when not obtained from the data subject

## Purpose

Organization-level policy/procedure template aligned to control `Art_14`. Replace bracketed fields; not legal advice.
