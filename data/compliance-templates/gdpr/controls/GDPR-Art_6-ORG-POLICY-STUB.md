...
**Control:** `Art_6`  
**Summary:** GDPR Article 6 — Lawfulness of processing

## Purpose

Organization-level policy/procedure template aligned to control `Art_6`. Replace bracketed fields; not legal advice.
