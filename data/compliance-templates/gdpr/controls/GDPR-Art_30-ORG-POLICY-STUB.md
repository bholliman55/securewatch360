...
**Control:** `Art_30`  
**Summary:** GDPR Article 30 — Records of processing activities

## Purpose

Organization-level policy/procedure template aligned to control `Art_30`. Replace bracketed fields; not legal advice.
