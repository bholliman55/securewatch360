...
**Control:** `Art_13`  
**Summary:** GDPR Article 13 — Information to be provided when collected from the data subject

## Purpose

Organization-level policy/procedure template aligned to control `Art_13`. Replace bracketed fields; not legal advice.
