...
**Control:** `Art_28`  
**Summary:** GDPR Article 28 — Processor obligations

## Purpose

Organization-level policy/procedure template aligned to control `Art_28`. Replace bracketed fields; not legal advice.
