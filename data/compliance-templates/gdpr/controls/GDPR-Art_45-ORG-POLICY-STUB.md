...
**Control:** `Art_45`  
**Summary:** GDPR Article 45 — Transfers on the basis of an adequacy decision

## Purpose

Organization-level policy/procedure template aligned to control `Art_45`. Replace bracketed fields; not legal advice.
