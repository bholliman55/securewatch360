...
**Control:** `Art_47`  
**Summary:** GDPR Article 47 — Binding corporate rules

## Purpose

Organization-level policy/procedure template aligned to control `Art_47`. Replace bracketed fields; not legal advice.
