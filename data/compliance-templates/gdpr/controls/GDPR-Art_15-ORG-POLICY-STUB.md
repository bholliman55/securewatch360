...
**Control:** `Art_15`  
**Summary:** GDPR Article 15 — Right of access by the data subject

## Purpose

Organization-level policy/procedure template aligned to control `Art_15`. Replace bracketed fields; not legal advice.
