...
**Control:** `Art_21`  
**Summary:** GDPR Article 21 — Right to object

## Purpose

Organization-level policy/procedure template aligned to control `Art_21`. Replace bracketed fields; not legal advice.
