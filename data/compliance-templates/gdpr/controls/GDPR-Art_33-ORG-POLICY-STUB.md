...
**Framework:** GDPR (SecureWatch360 policy pack catalog)  
**Control:** `Art_33`  
**Summary:** GDPR Article 33 — Notification of a personal data breach to the supervisory authority

## Purpose

Organization-level policy/procedure template aligned to control `Art_33`. Replace bracketed fields; not legal advice.
