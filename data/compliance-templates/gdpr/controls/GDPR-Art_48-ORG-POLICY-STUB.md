...
**Control:** `Art_48`  
**Summary:** GDPR Article 48 — Transfers not authorized by Union law

## Purpose

Organization-level policy/procedure template aligned to control `Art_48`. Replace bracketed fields; not legal advice.
