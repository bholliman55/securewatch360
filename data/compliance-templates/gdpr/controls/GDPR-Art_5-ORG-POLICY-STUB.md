...
**Control:** `Art_5`  
**Summary:** GDPR Article 5 — Principles relating to processing of personal data

## Purpose

Organization-level policy/procedure template aligned to control `Art_5`. Replace bracketed fields; not legal advice.
