...
**Control:** `Art_9`  
**Summary:** GDPR Article 9 — Processing of special categories

## Purpose

Organization-level policy/procedure template aligned to control `Art_9`. Replace bracketed fields; not legal advice.
