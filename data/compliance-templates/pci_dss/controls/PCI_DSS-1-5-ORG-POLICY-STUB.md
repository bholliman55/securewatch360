...
**Control:** `1.5`  
**Summary:** PCI DSS v4 — Requirement 1.5 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `1.5`. Replace bracketed fields; not legal advice.
