...
**Control:** `4.1`  
**Summary:** PCI DSS v4 — Requirement 4.1 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `4.1`. Replace bracketed fields; not legal advice.
