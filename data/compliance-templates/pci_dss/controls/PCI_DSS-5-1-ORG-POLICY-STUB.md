...
**Control:** `5.1`  
**Summary:** PCI DSS v4 — Requirement 5.1 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `5.1`. Replace bracketed fields; not legal advice.
