...
**Control:** `8.1`  
**Summary:** PCI DSS v4 — Requirement 8.1 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `8.1`. Replace bracketed fields; not legal advice.
