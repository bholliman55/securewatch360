...
**Control:** `7.6`  
**Summary:** PCI DSS v4 — Requirement 7.6 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `7.6`. Replace bracketed fields; not legal advice.
