...
**Control:** `3.6`  
**Summary:** PCI DSS v4 — Requirement 3.6 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `3.6`. Replace bracketed fields; not legal advice.
