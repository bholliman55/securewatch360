...
**Control:** `9.1`  
**Summary:** PCI DSS v4 — Requirement 9.1 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `9.1`. Replace bracketed fields; not legal advice.
