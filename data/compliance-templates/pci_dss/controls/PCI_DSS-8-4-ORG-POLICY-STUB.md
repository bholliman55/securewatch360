...
**Control:** `8.4`  
**Summary:** PCI DSS v4 — Requirement 8.4 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `8.4`. Replace bracketed fields; not legal advice.
