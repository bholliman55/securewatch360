...
**Control:** `9.3`  
**Summary:** PCI DSS v4 — Requirement 9.3 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `9.3`. Replace bracketed fields; not legal advice.
