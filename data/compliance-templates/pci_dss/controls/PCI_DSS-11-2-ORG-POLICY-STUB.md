...
**Framework:** PCI_DSS (SecureWatch360 policy pack catalog)  
**Control:** `11.2`  
**Summary:** PCI DSS v4 — Requirement 11.2 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `11.2`. Replace bracketed fields; not legal advice.
