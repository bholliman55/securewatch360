...
**Control:** `1.2`  
**Summary:** PCI DSS v4 — Requirement 1.2 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `1.2`. Replace bracketed fields; not legal advice.
