...
**Control:** `7.4`  
**Summary:** PCI DSS v4 — Requirement 7.4 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `7.4`. Replace bracketed fields; not legal advice.
