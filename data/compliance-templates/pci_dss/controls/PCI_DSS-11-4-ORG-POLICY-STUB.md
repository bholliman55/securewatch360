...
**Control:** `11.4`  
**Summary:** PCI DSS v4 — Requirement 11.4 (define testing procedures per PCI SSC standard)

## Purpose

Organization-level policy/procedure template aligned to control `11.4`. Replace bracketed fields; not legal advice.
