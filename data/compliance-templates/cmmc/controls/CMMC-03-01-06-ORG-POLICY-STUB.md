...
**Control:** `03.01.06`  
**Summary:** Least Privilege – Privileged Accounts

## Purpose

Organization-level policy/procedure template aligned to control `03.01.06`. Replace bracketed fields; not legal advice.
