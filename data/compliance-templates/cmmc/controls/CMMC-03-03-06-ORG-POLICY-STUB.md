...
**Control:** `03.03.06`  
**Summary:** Audit Record Reduction and Report Generation

## Purpose

Organization-level policy/procedure template aligned to control `03.03.06`. Replace bracketed fields; not legal advice.
