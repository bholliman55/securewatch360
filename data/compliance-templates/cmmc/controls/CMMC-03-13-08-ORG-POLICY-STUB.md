...
**Control:** `03.13.08`  
**Summary:** Transmission and Storage Confidentiality

## Purpose

Organization-level policy/procedure template aligned to control `03.13.08`. Replace bracketed fields; not legal advice.
