...
**Control:** `03.10.01`  
**Summary:** Physical Access Authorizations

## Purpose

Organization-level policy/procedure template aligned to control `03.10.01`. Replace bracketed fields; not legal advice.
