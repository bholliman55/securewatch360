...
**Control:** `03.05.04`  
**Summary:** Replay-Resistant Authentication

## Purpose

Organization-level policy/procedure template aligned to control `03.05.04`. Replace bracketed fields; not legal advice.
