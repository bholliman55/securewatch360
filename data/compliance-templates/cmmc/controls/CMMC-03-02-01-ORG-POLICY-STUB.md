...
**Control:** `03.02.01`  
**Summary:** Literacy Training and Awareness

## Purpose

Organization-level policy/procedure template aligned to control `03.02.01`. Replace bracketed fields; not legal advice.
