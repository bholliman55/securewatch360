...
**Control:** `03.01.03`  
**Summary:** Information Flow Enforcement

## Purpose

Organization-level policy/procedure template aligned to control `03.01.03`. Replace bracketed fields; not legal advice.
