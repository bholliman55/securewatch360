...
**Control:** `03.05.02`  
**Summary:** Device Identification and Authentication

## Purpose

Organization-level policy/procedure template aligned to control `03.05.02`. Replace bracketed fields; not legal advice.
