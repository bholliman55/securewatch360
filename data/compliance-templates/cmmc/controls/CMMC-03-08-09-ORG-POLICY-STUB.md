...
**Control:** `03.08.09`  
**Summary:** System Backup – Cryptographic Protection

## Purpose

Organization-level policy/procedure template aligned to control `03.08.09`. Replace bracketed fields; not legal advice.
