...
**Framework:** CMMC (SecureWatch360 policy pack catalog)  
**Control:** `03.13.06`  
**Summary:** Network Communications – Deny by Default – Allow by Exception

## Purpose

Organization-level policy/procedure template aligned to control `03.13.06`. Replace bracketed fields; not legal advice.
