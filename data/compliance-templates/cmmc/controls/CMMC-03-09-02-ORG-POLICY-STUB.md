...
**Control:** `03.09.02`  
**Summary:** Personnel Termination and Transfer

## Purpose

Organization-level policy/procedure template aligned to control `03.09.02`. Replace bracketed fields; not legal advice.
