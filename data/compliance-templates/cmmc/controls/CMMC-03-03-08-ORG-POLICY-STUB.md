...
**Control:** `03.03.08`  
**Summary:** Protection of Audit Information

## Purpose

Organization-level policy/procedure template aligned to control `03.03.08`. Replace bracketed fields; not legal advice.
