...
**Control:** `03.01.07`  
**Summary:** Least Privilege – Privileged Functions

## Purpose

Organization-level policy/procedure template aligned to control `03.01.07`. Replace bracketed fields; not legal advice.
