...
**Control:** `03.17.01`  
**Summary:** Supply Chain Risk Management Plan

## Purpose

Organization-level policy/procedure template aligned to control `03.17.01`. Replace bracketed fields; not legal advice.
