...
**Control:** `03.13.10`  
**Summary:** Cryptographic Key Establishment and Management

## Purpose

Organization-level policy/procedure template aligned to control `03.13.10`. Replace bracketed fields; not legal advice.
