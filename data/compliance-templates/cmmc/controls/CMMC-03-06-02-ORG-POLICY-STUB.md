...
**Control:** `03.06.02`  
**Summary:** Incident Monitoring, Reporting, and Response Assistance

## Purpose

Organization-level policy/procedure template aligned to control `03.06.02`. Replace bracketed fields; not legal advice.
