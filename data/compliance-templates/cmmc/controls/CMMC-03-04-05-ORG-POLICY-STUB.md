...
**Control:** `03.04.05`  
**Summary:** Access Restrictions for Change

## Purpose

Organization-level policy/procedure template aligned to control `03.04.05`. Replace bracketed fields; not legal advice.
