...
**Control:** `03.01.18`  
**Summary:** Access Control for Mobile Devices

## Purpose

Organization-level policy/procedure template aligned to control `03.01.18`. Replace bracketed fields; not legal advice.
