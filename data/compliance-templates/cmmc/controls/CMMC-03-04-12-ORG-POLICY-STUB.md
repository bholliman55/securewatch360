...
**Control:** `03.04.12`  
**Summary:** System and Component Configuration for High-Risk Areas

## Purpose

Organization-level policy/procedure template aligned to control `03.04.12`. Replace bracketed fields; not legal advice.
