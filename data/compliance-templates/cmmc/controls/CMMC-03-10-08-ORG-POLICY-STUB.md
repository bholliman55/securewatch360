...
**Control:** `03.10.08`  
**Summary:** Access Control for Transmission

## Purpose

Organization-level policy/procedure template aligned to control `03.10.08`. Replace bracketed fields; not legal advice.
