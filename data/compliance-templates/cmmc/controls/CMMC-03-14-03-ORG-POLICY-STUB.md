...
**Control:** `03.14.03`  
**Summary:** Security Alerts, Advisories, and Directives

## Purpose

Organization-level policy/procedure template aligned to control `03.14.03`. Replace bracketed fields; not legal advice.
