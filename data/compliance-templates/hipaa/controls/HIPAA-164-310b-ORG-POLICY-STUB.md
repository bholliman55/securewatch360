...
**Control:** `164.310(b)`  
**Summary:** HIPAA Security Rule 164.310(b) — Workstation use

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.310(b)`.  
...
- **Catalog note:** Catalog control 164.310(b). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
