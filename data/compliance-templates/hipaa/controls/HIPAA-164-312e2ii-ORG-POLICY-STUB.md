...
**Summary:** HIPAA Security Rule 164.312(e)(2)(ii) — Encryption

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.312(e)(2)(ii)`.  
...
- **Catalog note:** Catalog control 164.312(e)(2)(ii). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
