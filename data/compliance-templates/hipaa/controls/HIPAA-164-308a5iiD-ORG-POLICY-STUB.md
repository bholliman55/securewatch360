...
**Summary:** HIPAA Security Rule 164.308(a)(5)(ii)(D) — Password management

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.308(a)(5)(ii)(D)`.  
...
- **Catalog note:** Catalog control 164.308(a)(5)(ii)(D). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
