...
**Control:** `164.312(d)`  
**Summary:** HIPAA Security Rule 164.312(d) — Person or entity authentication

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.312(d)`.  
...
- **Catalog note:** Catalog control 164.312(d). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
