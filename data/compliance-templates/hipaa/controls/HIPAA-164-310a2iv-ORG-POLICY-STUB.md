...
**Summary:** HIPAA Security Rule 164.310(a)(2)(iv) — Maintenance records

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.310(a)(2)(iv)`.  
...
- **Catalog note:** Catalog control 164.310(a)(2)(iv). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
