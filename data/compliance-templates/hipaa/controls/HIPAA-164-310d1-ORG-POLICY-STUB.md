...
**Control:** `164.310(d)(1)`  
**Summary:** HIPAA Security Rule 164.310(d)(1) — Device and media controls — disposal

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.310(d)(1)`.  
...
- **Catalog note:** Catalog control 164.310(d)(1). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
