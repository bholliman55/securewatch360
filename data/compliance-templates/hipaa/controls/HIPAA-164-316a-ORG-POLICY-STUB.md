...
**Control:** `164.316(a)`  
**Summary:** HIPAA Security Rule 164.316(a) — Policies and procedures

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.316(a)`.  
...
- **Catalog note:** Catalog control 164.316(a). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
