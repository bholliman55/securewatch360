...
**Summary:** HIPAA Security Rule 164.308(a)(1)(ii)(B) — Risk management

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.308(a)(1)(ii)(B)`.  
...
- **Catalog note:** Catalog control 164.308(a)(1)(ii)(B). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
