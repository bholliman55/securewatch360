...
**Control:** `164.310(c)`  
**Summary:** HIPAA Security Rule 164.310(c) — Workstation security

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.310(c)`.  
...
- **Catalog note:** Catalog control 164.310(c). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
