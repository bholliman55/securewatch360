...
**Control:** `164.312(b)`  
**Summary:** HIPAA Security Rule 164.312(b) — Audit controls

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.312(b)`.  
...
- **Catalog note:** Catalog control 164.312(b). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
