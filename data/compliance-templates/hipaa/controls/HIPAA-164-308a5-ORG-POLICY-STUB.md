...
**Control:** `164.308(a)(5)`  
**Summary:** HIPAA Security Rule 164.308(a)(5) — Security awareness and training

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.308(a)(5)`.  
...
- **Catalog note:** Catalog control 164.308(a)(5). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
