...
**Summary:** HIPAA Security Rule 164.312(a)(2)(i) — Emergency access procedure

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.312(a)(2)(i)`.  
...
- **Catalog note:** Catalog control 164.312(a)(2)(i). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
