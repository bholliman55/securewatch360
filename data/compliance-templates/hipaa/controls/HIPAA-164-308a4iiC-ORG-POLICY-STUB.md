...
**Summary:** HIPAA Security Rule 164.308(a)(4)(ii)(C) — Access establishment and modification

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.308(a)(4)(ii)(C)`.  
...
- **Catalog note:** Catalog control 164.308(a)(4)(ii)(C). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
