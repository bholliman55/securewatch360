...
**Summary:** HIPAA Security Rule 164.308(a)(7)(ii)(E) — Applications and data criticality analysis

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.308(a)(7)(ii)(E)`.  
...
- **Catalog note:** Catalog control 164.308(a)(7)(ii)(E). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
