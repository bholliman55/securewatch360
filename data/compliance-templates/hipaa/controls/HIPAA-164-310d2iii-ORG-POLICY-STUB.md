...
**Summary:** HIPAA Security Rule 164.310(d)(2)(iii) — Data backup and storage

## Purpose

This document is an organization-level policy/procedure **template** aligned to control `164.310(d)(2)(iii)`.  
...
- **Catalog note:** Catalog control 164.310(d)(2)(iii). Map evidence collection, ownership, and automation to organizational policy. Framework: HIPAA Security Rule (45 CFR Part 164 Subpart C).
