...
**Control:** `A.6.6`  
**Summary:** Confidentiality or non-disclosure agreements

## Purpose

Organization-level policy/procedure template aligned to control `A.6.6`. Replace bracketed fields; not legal advice.
