...
**Control:** `A.6.8`  
**Summary:** Information security event reporting

## Purpose

Organization-level policy/procedure template aligned to control `A.6.8`. Replace bracketed fields; not legal advice.
