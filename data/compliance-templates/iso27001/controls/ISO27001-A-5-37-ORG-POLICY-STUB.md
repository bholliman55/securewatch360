...
**Control:** `A.5.37`  
**Summary:** Documented operating procedures for information security

## Purpose

Organization-level policy/procedure template aligned to control `A.5.37`. Replace bracketed fields; not legal advice.
