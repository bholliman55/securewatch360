...
**Control:** `A.5.31`  
**Summary:** Legal, statutory, regulatory and contractual requirements

## Purpose

Organization-level policy/procedure template aligned to control `A.5.31`. Replace bracketed fields; not legal advice.
