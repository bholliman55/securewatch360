...
**Control:** `A.5.34`  
**Summary:** Privacy and protection of personally identifiable information

## Purpose

Organization-level policy/procedure template aligned to control `A.5.34`. Replace bracketed fields; not legal advice.
