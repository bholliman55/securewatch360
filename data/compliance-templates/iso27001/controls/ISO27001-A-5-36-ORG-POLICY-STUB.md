...
**Framework:** ISO27001 (SecureWatch360 policy pack catalog)  
**Control:** `A.5.36`  
**Summary:** Compliance with policies, rules and standards for information security

## Purpose

Organization-level policy/procedure template aligned to control `A.5.36`. Replace bracketed fields; not legal advice.
