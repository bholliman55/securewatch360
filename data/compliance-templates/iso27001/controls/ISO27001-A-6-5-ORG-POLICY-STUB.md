...
**Control:** `A.6.5`  
**Summary:** Information security awareness, education and training

## Purpose

Organization-level policy/procedure template aligned to control `A.6.5`. Replace bracketed fields; not legal advice.
