...
**Control:** `A.5.8`  
**Summary:** Information security in project management

## Purpose

Organization-level policy/procedure template aligned to control `A.5.8`. Replace bracketed fields; not legal advice.
