...
**Control:** `A.5.10`  
**Summary:** Acceptable use of information and other associated assets

## Purpose

Organization-level policy/procedure template aligned to control `A.5.10`. Replace bracketed fields; not legal advice.
