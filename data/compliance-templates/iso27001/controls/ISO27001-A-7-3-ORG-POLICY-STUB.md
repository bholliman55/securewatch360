...
**Control:** `A.7.3`  
**Summary:** Securing offices, rooms and facilities

## Purpose

Organization-level policy/procedure template aligned to control `A.7.3`. Replace bracketed fields; not legal advice.
