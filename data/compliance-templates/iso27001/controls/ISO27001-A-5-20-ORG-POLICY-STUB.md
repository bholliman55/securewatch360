...
**Control:** `A.5.20`  
**Summary:** Addressing information security within supplier agreements

## Purpose

Organization-level policy/procedure template aligned to control `A.5.20`. Replace bracketed fields; not legal advice.
