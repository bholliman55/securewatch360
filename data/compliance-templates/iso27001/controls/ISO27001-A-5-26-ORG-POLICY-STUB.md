...
**Control:** `A.5.26`  
**Summary:** Response to information security incidents

## Purpose

Organization-level policy/procedure template aligned to control `A.5.26`. Replace bracketed fields; not legal advice.
