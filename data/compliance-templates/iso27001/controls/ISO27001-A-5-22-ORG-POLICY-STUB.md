...
**Control:** `A.5.22`  
**Summary:** Monitoring, review and change management of supplier services

## Purpose

Organization-level policy/procedure template aligned to control `A.5.22`. Replace bracketed fields; not legal advice.
