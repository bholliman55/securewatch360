...
**Control:** `A.7.9`  
**Summary:** Security of assets off-premises

## Purpose

Organization-level policy/procedure template aligned to control `A.7.9`. Replace bracketed fields; not legal advice.
