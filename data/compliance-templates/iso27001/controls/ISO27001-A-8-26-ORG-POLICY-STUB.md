...
**Control:** `A.8.26`  
**Summary:** Application security requirements

## Purpose

Organization-level policy/procedure template aligned to control `A.8.26`. Replace bracketed fields; not legal advice.
