...
**Control:** `A.5.19`  
**Summary:** Information security in supplier relationships

## Purpose

Organization-level policy/procedure template aligned to control `A.5.19`. Replace bracketed fields; not legal advice.
