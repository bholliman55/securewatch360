...
**Control:** `A.8.34`  
**Summary:** Protection of information systems during audit testing

## Purpose

Organization-level policy/procedure template aligned to control `A.8.34`. Replace bracketed fields; not legal advice.
