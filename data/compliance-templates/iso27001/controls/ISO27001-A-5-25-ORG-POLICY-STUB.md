...
**Control:** `A.5.25`  
**Summary:** Assessment and decision on information security incidents

## Purpose

Organization-level policy/procedure template aligned to control `A.5.25`. Replace bracketed fields; not legal advice.
