...
**Control:** `A.7.14`  
**Summary:** Secure disposal or re-use of equipment

## Purpose

Organization-level policy/procedure template aligned to control `A.7.14`. Replace bracketed fields; not legal advice.
