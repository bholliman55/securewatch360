...
**Control:** `A.8.19`  
**Summary:** Installation of software on operational systems

## Purpose

Organization-level policy/procedure template aligned to control `A.8.19`. Replace bracketed fields; not legal advice.
