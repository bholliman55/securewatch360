...
**Control:** `A.5.6`  
**Summary:** Contact with special interest groups

## Purpose

Organization-level policy/procedure template aligned to control `A.5.6`. Replace bracketed fields; not legal advice.
