...
**Control:** `A.5.9`  
**Summary:** Inventory of information and other associated assets

## Purpose

Organization-level policy/procedure template aligned to control `A.5.9`. Replace bracketed fields; not legal advice.
