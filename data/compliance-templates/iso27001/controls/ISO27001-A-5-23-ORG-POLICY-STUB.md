...
**Control:** `A.5.23`  
**Summary:** Information security for use of cloud services

## Purpose

Organization-level policy/procedure template aligned to control `A.5.23`. Replace bracketed fields; not legal advice.
