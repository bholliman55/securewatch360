...
**Control:** `A.8.14`  
**Summary:** Redundancy of information processing facilities

## Purpose

Organization-level policy/procedure template aligned to control `A.8.14`. Replace bracketed fields; not legal advice.
