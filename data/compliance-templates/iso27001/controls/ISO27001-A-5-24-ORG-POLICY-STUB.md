...
**Control:** `A.5.24`  
**Summary:** Information security incident management planning and preparation

## Purpose

Organization-level policy/procedure template aligned to control `A.5.24`. Replace bracketed fields; not legal advice.
