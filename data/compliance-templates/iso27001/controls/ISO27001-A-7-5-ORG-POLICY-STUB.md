...
**Control:** `A.7.5`  
**Summary:** Protecting against physical and environmental threats

## Purpose

Organization-level policy/procedure template aligned to control `A.7.5`. Replace bracketed fields; not legal advice.
