...
**Control:** `A.8.27`  
**Summary:** Secure system architecture and engineering principles

## Purpose

Organization-level policy/procedure template aligned to control `A.8.27`. Replace bracketed fields; not legal advice.
