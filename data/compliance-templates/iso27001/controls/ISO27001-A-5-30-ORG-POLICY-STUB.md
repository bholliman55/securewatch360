...
**Control:** `A.5.30`  
**Summary:** ICT readiness for business continuity

## Purpose

Organization-level policy/procedure template aligned to control `A.5.30`. Replace bracketed fields; not legal advice.
