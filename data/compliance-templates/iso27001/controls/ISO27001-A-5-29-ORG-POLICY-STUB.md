...
**Control:** `A.5.29`  
**Summary:** Information security during disruption

## Purpose

Organization-level policy/procedure template aligned to control `A.5.29`. Replace bracketed fields; not legal advice.
