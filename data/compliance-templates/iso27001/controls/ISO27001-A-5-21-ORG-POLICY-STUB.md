...
**Control:** `A.5.21`  
**Summary:** Managing information security in the ICT supply chain

## Purpose

Organization-level policy/procedure template aligned to control `A.5.21`. Replace bracketed fields; not legal advice.
