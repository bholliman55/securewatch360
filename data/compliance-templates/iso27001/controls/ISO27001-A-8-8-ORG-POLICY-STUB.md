...
**Control:** `A.8.8`  
**Summary:** Management of technical vulnerabilities

## Purpose

Organization-level policy/procedure template aligned to control `A.8.8`. Replace bracketed fields; not legal advice.
