...
**Control:** `A.5.2`  
**Summary:** Information security roles and responsibilities

## Purpose

Organization-level policy/procedure template aligned to control `A.5.2`. Replace bracketed fields; not legal advice.
