...
**Control:** `A.5.35`  
**Summary:** Independent review of information security

## Purpose

Organization-level policy/procedure template aligned to control `A.5.35`. Replace bracketed fields; not legal advice.
