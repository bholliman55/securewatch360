...
**Control:** `A.7.8`  
**Summary:** Equipment siting and protection

## Purpose

Organization-level policy/procedure template aligned to control `A.7.8`. Replace bracketed fields; not legal advice.
