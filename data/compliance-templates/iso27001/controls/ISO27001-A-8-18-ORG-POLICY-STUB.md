...
**Control:** `A.8.18`  
**Summary:** Use of privileged utility programs

## Purpose

Organization-level policy/procedure template aligned to control `A.8.18`. Replace bracketed fields; not legal advice.
