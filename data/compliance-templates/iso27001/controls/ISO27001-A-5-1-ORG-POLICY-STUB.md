...
**Control:** `A.5.1`  
**Summary:** Policies for information security

## Purpose

Organization-level policy/procedure template aligned to control `A.5.1`. Replace bracketed fields; not legal advice.
