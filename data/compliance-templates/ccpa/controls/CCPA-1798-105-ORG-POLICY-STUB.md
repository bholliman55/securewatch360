...
**Control:** `1798.105`  
**Summary:** CCPA 1798.105 — Consumer right to delete

## Purpose

Organization-level policy/procedure template aligned to control `1798.105`. Replace bracketed fields; not legal advice.
