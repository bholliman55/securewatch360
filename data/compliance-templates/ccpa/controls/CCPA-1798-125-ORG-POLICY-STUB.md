...
**Control:** `1798.125`  
**Summary:** CCPA 1798.125 — Non-discrimination

## Purpose

Organization-level policy/procedure template aligned to control `1798.125`. Replace bracketed fields; not legal advice.
