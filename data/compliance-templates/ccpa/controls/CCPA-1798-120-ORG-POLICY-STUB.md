...
**Control:** `1798.120`  
**Summary:** CCPA 1798.120 — Consumer right to opt-out of sale/sharing

## Purpose

Organization-level policy/procedure template aligned to control `1798.120`. Replace bracketed fields; not legal advice.
