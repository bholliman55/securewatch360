...
**Control:** `1798.198`  
**Summary:** CCPA 1798.198 — Violations involving minors

## Purpose

Organization-level policy/procedure template aligned to control `1798.198`. Replace bracketed fields; not legal advice.
