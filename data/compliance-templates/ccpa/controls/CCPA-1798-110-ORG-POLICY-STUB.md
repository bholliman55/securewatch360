...
**Control:** `1798.110`  
**Summary:** CCPA 1798.110 — Business disclosure obligations (categories)

## Purpose

Organization-level policy/procedure template aligned to control `1798.110`. Replace bracketed fields; not legal advice.
