...
**Framework:** CCPA (SecureWatch360 policy pack catalog)  
**Control:** `1798.100`  
**Summary:** CCPA 1798.100 — Consumer right to know categories and specific pieces of PI

## Purpose

Organization-level policy/procedure template aligned to control `1798.100`. Replace bracketed fields; not legal advice.
