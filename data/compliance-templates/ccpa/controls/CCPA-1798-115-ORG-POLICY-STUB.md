...
**Control:** `1798.115`  
**Summary:** CCPA 1798.115 — Business disclosure obligations (specific pieces)

## Purpose

Organization-level policy/procedure template aligned to control `1798.115`. Replace bracketed fields; not legal advice.
