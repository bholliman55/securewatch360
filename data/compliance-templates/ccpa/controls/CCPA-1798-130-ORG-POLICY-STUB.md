...
**Control:** `1798.130`  
**Summary:** CCPA 1798.130 — Notice at collection

## Purpose

Organization-level policy/procedure template aligned to control `1798.130`. Replace bracketed fields; not legal advice.
