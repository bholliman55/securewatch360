...
**Control:** `1798.121`  
**Summary:** CCPA 1798.121 — Consumer right to limit use of sensitive PI

## Purpose

Organization-level policy/procedure template aligned to control `1798.121`. Replace bracketed fields; not legal advice.
