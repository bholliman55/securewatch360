...
**Control:** `1798.135`  
**Summary:** CCPA 1798.135 — Authorized agent requests

## Purpose

Organization-level policy/procedure template aligned to control `1798.135`. Replace bracketed fields; not legal advice.
