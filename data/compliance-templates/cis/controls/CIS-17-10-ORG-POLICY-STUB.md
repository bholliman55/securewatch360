...
**Framework:** CIS (SecureWatch360 policy pack catalog)  
**Control:** `17.10`  
**Summary:** CIS Controls v8 Safeguard 17.10

## Purpose

Organization-level policy/procedure template aligned to control `17.10`. Replace bracketed fields; not legal advice.
