...
**Control:** `18.12`  
**Summary:** CIS Controls v8 Safeguard 18.12

## Purpose

Organization-level policy/procedure template aligned to control `18.12`. Replace bracketed fields; not legal advice.
