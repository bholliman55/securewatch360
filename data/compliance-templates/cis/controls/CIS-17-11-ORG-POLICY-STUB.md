...
**Control:** `17.11`  
**Summary:** CIS Controls v8 Safeguard 17.11

## Purpose

Organization-level policy/procedure template aligned to control `17.11`. Replace bracketed fields; not legal advice.
