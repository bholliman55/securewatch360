...
**Control:** `13.11`  
**Summary:** CIS Controls v8 Safeguard 13.11

## Purpose

Organization-level policy/procedure template aligned to control `13.11`. Replace bracketed fields; not legal advice.
