...
**Control:** `18.11`  
**Summary:** CIS Controls v8 Safeguard 18.11

## Purpose

Organization-level policy/procedure template aligned to control `18.11`. Replace bracketed fields; not legal advice.
