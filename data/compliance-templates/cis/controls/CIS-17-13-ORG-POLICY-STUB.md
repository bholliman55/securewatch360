...
**Control:** `17.13`  
**Summary:** CIS Controls v8 Safeguard 17.13

## Purpose

Organization-level policy/procedure template aligned to control `17.13`. Replace bracketed fields; not legal advice.
