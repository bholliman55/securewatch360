...
**Control:** `17.12`  
**Summary:** CIS Controls v8 Safeguard 17.12

## Purpose

Organization-level policy/procedure template aligned to control `17.12`. Replace bracketed fields; not legal advice.
