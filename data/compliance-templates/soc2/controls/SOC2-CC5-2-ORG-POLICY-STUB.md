...
**Control:** `CC5.2`  
**Summary:** SOC 2 (TSC Security) — CC5.2 (Control activities)

## Purpose

Organization-level policy/procedure template aligned to control `CC5.2`. Replace bracketed fields; not legal advice.
