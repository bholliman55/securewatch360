...
**Control:** `CC6.7`  
**Summary:** SOC 2 (TSC Security) — CC6.7 (Logical and physical access)

## Purpose

Organization-level policy/procedure template aligned to control `CC6.7`. Replace bracketed fields; not legal advice.
