...
**Control:** `CC6.6`  
**Summary:** SOC 2 (TSC Security) — CC6.6 (Logical and physical access)

## Purpose

Organization-level policy/procedure template aligned to control `CC6.6`. Replace bracketed fields; not legal advice.
