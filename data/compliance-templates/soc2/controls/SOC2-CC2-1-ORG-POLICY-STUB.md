...
**Framework:** SOC2 (SecureWatch360 policy pack catalog)  
**Control:** `CC2.1`  
**Summary:** SOC 2 (TSC Security) — CC2.1 (Communication and information)

## Purpose

Organization-level policy/procedure template aligned to control `CC2.1`. Replace bracketed fields; not legal advice.
