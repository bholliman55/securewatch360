...
**Control:** `CC3.1`  
**Summary:** SOC 2 (TSC Security) — CC3.1 (Risk assessment)

## Purpose

Organization-level policy/procedure template aligned to control `CC3.1`. Replace bracketed fields; not legal advice.
