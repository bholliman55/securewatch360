...
**Control:** `CC9.2`  
**Summary:** SOC 2 (TSC Security) — CC9.2 (Risk mitigation)

## Purpose

Organization-level policy/procedure template aligned to control `CC9.2`. Replace bracketed fields; not legal advice.
