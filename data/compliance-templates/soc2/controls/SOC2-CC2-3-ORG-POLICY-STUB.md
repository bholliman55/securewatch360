...
**Control:** `CC2.3`  
**Summary:** SOC 2 (TSC Security) — CC2.3 (Communication and information)

## Purpose

Organization-level policy/procedure template aligned to control `CC2.3`. Replace bracketed fields; not legal advice.
