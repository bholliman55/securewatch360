...
**Control:** `CC6.2`  
**Summary:** SOC 2 (TSC Security) — CC6.2 (Logical and physical access)

## Purpose

Organization-level policy/procedure template aligned to control `CC6.2`. Replace bracketed fields; not legal advice.
