...
**Control:** `CC6.5`  
**Summary:** SOC 2 (TSC Security) — CC6.5 (Logical and physical access)

## Purpose

Organization-level policy/procedure template aligned to control `CC6.5`. Replace bracketed fields; not legal advice.
