...
**Control:** `CC6.1`  
**Summary:** SOC 2 (TSC Security) — CC6.1 (Logical and physical access)

## Purpose

Organization-level policy/procedure template aligned to control `CC6.1`. Replace bracketed fields; not legal advice.
