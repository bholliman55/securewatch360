...
**Control:** `CC1.2`  
**Summary:** SOC 2 (TSC Security) — CC1.2 (Control environment)

## Purpose

Organization-level policy/procedure template aligned to control `CC1.2`. Replace bracketed fields; not legal advice.
