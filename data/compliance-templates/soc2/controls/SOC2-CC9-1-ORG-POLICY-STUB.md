...
**Control:** `CC9.1`  
**Summary:** SOC 2 (TSC Security) — CC9.1 (Risk mitigation)

## Purpose

Organization-level policy/procedure template aligned to control `CC9.1`. Replace bracketed fields; not legal advice.
