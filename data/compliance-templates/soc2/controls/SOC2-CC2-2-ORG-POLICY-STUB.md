...
**Control:** `CC2.2`  
**Summary:** SOC 2 (TSC Security) — CC2.2 (Communication and information)

## Purpose

Organization-level policy/procedure template aligned to control `CC2.2`. Replace bracketed fields; not legal advice.
