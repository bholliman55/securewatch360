...
**Control:** `CC7.4`  
**Summary:** SOC 2 (TSC Security) — CC7.4 (System operations)

## Purpose

Organization-level policy/procedure template aligned to control `CC7.4`. Replace bracketed fields; not legal advice.
