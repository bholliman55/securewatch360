...
**Control:** `CC3.3`  
**Summary:** SOC 2 (TSC Security) — CC3.3 (Risk assessment)

## Purpose

Organization-level policy/procedure template aligned to control `CC3.3`. Replace bracketed fields; not legal advice.
