...
**Control:** `CC6.4`  
**Summary:** SOC 2 (TSC Security) — CC6.4 (Logical and physical access)

## Purpose

Organization-level policy/procedure template aligned to control `CC6.4`. Replace bracketed fields; not legal advice.
