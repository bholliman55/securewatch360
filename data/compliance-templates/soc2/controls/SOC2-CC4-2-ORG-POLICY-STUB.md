...
**Control:** `CC4.2`  
**Summary:** SOC 2 (TSC Security) — CC4.2 (Monitoring activities)

## Purpose

Organization-level policy/procedure template aligned to control `CC4.2`. Replace bracketed fields; not legal advice.
