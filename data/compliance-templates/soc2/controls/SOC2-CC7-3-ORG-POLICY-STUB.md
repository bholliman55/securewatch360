...
**Control:** `CC7.3`  
**Summary:** SOC 2 (TSC Security) — CC7.3 (System operations)

## Purpose

Organization-level policy/procedure template aligned to control `CC7.3`. Replace bracketed fields; not legal advice.
