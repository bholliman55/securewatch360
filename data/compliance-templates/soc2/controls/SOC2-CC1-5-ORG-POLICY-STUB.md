...
**Control:** `CC1.5`  
**Summary:** SOC 2 (TSC Security) — CC1.5 (Control environment)

## Purpose

Organization-level policy/procedure template aligned to control `CC1.5`. Replace bracketed fields; not legal advice.
