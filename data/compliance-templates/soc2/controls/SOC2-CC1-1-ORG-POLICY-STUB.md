...
**Control:** `CC1.1`  
**Summary:** SOC 2 (TSC Security) — CC1.1 (Control environment)

## Purpose

Organization-level policy/procedure template aligned to control `CC1.1`. Replace bracketed fields; not legal advice.
