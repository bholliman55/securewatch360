...
**Control:** `CC6.3`  
**Summary:** SOC 2 (TSC Security) — CC6.3 (Logical and physical access)

## Purpose

Organization-level policy/procedure template aligned to control `CC6.3`. Replace bracketed fields; not legal advice.
