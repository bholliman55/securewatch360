...
**Control:** `CC6.8`  
**Summary:** SOC 2 (TSC Security) — CC6.8 (Logical and physical access)

## Purpose

Organization-level policy/procedure template aligned to control `CC6.8`. Replace bracketed fields; not legal advice.
