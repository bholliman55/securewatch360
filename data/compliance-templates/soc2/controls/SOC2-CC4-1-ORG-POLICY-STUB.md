...
**Control:** `CC4.1`  
**Summary:** SOC 2 (TSC Security) — CC4.1 (Monitoring activities)

## Purpose

Organization-level policy/procedure template aligned to control `CC4.1`. Replace bracketed fields; not legal advice.
