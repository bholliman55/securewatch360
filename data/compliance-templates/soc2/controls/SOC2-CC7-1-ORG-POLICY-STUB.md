...
**Control:** `CC7.1`  
**Summary:** SOC 2 (TSC Security) — CC7.1 (System operations)

## Purpose

Organization-level policy/procedure template aligned to control `CC7.1`. Replace bracketed fields; not legal advice.
