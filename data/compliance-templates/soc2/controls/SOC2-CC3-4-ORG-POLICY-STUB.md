...
**Control:** `CC3.4`  
**Summary:** SOC 2 (TSC Security) — CC3.4 (Risk assessment)

## Purpose

Organization-level policy/procedure template aligned to control `CC3.4`. Replace bracketed fields; not legal advice.
