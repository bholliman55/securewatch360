...
**Control:** `CC5.1`  
**Summary:** SOC 2 (TSC Security) — CC5.1 (Control activities)

## Purpose

Organization-level policy/procedure template aligned to control `CC5.1`. Replace bracketed fields; not legal advice.
