...
**Control:** `CC7.2`  
**Summary:** SOC 2 (TSC Security) — CC7.2 (System operations)

## Purpose

Organization-level policy/procedure template aligned to control `CC7.2`. Replace bracketed fields; not legal advice.
