...
**Control:** `CC3.2`  
**Summary:** SOC 2 (TSC Security) — CC3.2 (Risk assessment)

## Purpose

Organization-level policy/procedure template aligned to control `CC3.2`. Replace bracketed fields; not legal advice.
