...
**Control:** `CC1.3`  
**Summary:** SOC 2 (TSC Security) — CC1.3 (Control environment)

## Purpose

Organization-level policy/procedure template aligned to control `CC1.3`. Replace bracketed fields; not legal advice.
