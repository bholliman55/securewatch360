...
**Control:** `CC7.5`  
**Summary:** SOC 2 (TSC Security) — CC7.5 (System operations)

## Purpose

Organization-level policy/procedure template aligned to control `CC7.5`. Replace bracketed fields; not legal advice.
