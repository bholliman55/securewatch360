...
**Control:** `CC1.4`  
**Summary:** SOC 2 (TSC Security) — CC1.4 (Control environment)

## Purpose

Organization-level policy/procedure template aligned to control `CC1.4`. Replace bracketed fields; not legal advice.
