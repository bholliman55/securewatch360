...
**Control:** `CC5.3`  
**Summary:** SOC 2 (TSC Security) — CC5.3 (Control activities)

## Purpose

Organization-level policy/procedure template aligned to control `CC5.3`. Replace bracketed fields; not legal advice.
