...
**Control:** `CC8.1`  
**Summary:** SOC 2 (TSC Security) — CC8.1 (Change management)

## Purpose

Organization-level policy/procedure template aligned to control `CC8.1`. Replace bracketed fields; not legal advice.
